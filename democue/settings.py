"""
Django settings for Democue project.
...
SECRET_KEY = env("SECRET_KEY", default="PKJieuCqlCFAFJnfIxJpAKymAhrmoJELWxMDwjuR")
...
WSGI_APPLICATION = "democue.wsgi.application"
...
if "DATABASE_URL" in env:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DJANGO_DATABASE_NAME", default="democue"),
...
LANGUAGE_CODE = "en-us"
LANGUAGE_COOKIE_NAME = "democue_language"
LANGUAGES = [
...
LOGGING = {
    ...
    "loggers": {
        ...
        "democue": {
            "handlers": ["console"],
            "level": env("DEMOCUE_LOG_LEVEL", default="INFO"),
        },
    },
}
